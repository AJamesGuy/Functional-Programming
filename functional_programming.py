...
annual_sales = [{**product, 'total_sales': (product['q1'] + product['q2'] + product['q3'] + product['q4'])} for product in sales_data]
...
high_performers = [product['product'] for product in sales_data if product['q1'] + product['q2'] + product['q3'] + product['q4'] > 600]
...
growth_analysis = [{**product, 'growth_percentage': ((product['q4'] - product['q1']) / product['q1']) * 100} for product in sales_data if ((product['q4'] - product['q1']) / product['q1'] * 100) > 0]
